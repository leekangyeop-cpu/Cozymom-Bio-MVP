...
export default function Home() {
  ...
  const handleContactEmail = () => {
    const subject = encodeURIComponent('Root Inside 건강기능식품 AI 문의');
    const body = encodeURIComponent('안녕하세요,\n\nRoot Inside 건강기능식품 배합 최적화 시스템에 대해 문의드립니다.\n\n[문의 내용을 작성해주세요]');
      ...
      <section id="demo" className="py-20 px-6 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-4">
            <button
              onClick={() => setFormulationRequest('근육 회복과 면역력 강화를 위한 제품을 만들고 싶습니다. 알부민 300mg, 비타민C 150mg, 아연 10mg')}
              className="bg-white p-4 rounded-xl border-2 border-gray-200 hover:border-blue-500 transition-all text-left"
            >
              <div className="font-semibold text-gray-900 mb-2">케이스 A</div>
              <div className="text-sm text-gray-600">알부민 복합 제형</div>
            </button>
            <button
              onClick={() => setFormulationRequest('골격 건강과 혈행 개선을 위한 제품입니다. 칼슘 600mg, 마그네슘 200mg, 비타민D 20µg, 오메가3지방산 1.5g')}
              className="bg-white p-4 rounded-xl border-2 border-gray-200 hover:border-blue-500 transition-all text-left"
            >
              <div className="font-semibold text-gray-900 mb-2">케이스 B</div>
              <div className="text-sm text-gray-600">골격·혈행 복합</div>
            </button>
            <button
              onClick={() => setFormulationRequest('피로 개선과 항산화를 위한 제품입니다. 홍삼농축액 5%, 비타민C 200mg, 엽산 400µg')}
              className="bg-white p-4 rounded-xl border-2 border-gray-200 hover:border-blue-500 transition-all text-left"
            >
              <div className="font-semibold text-gray-900 mb-2">케이스 C</div>
              <div className="text-sm text-gray-600">홍삼 상한 확인</div>
            </button>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-12 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-sm text-gray-400">
            <p>© 2024 Root Inside Co., Ltd. All rights reserved.</p>
